...
class SRS_ONE(admin.ModelAdmin):
    list_display = ("id", "student", "subject", "week1", "week2", "week3", "week4", "week5", "week6", "week7", "week71", )
...
class SRS_TYO(admin.ModelAdmin):
    list_display = ("id", "student", "subject", "week8", "week9", "week10",  "week11",  "week12",  "week13",  "week14", "week15", "week16", )
    list_display_links = ("id", "student", "subject", )
    search_fields = ['id', 'student', 'subject']
    #list_filter = ['student', 'subject']
